...
=======
/*   Updated: 2025/07/29 10:58:35 by rgodet           ###   ########.fr       */
>>>>>>> 44948eda3e6e93af5c77c9ffe237b99a732cb496
/*                                                                            */
/* ************************************************************************** */
...
void					init_rad_floor(t_game *game, float *dir_x,
							float *dir_y);
void					raycasting_ghost(t_game *game, t_raycasting *ray,
							float *z_buffer);
...
void					sprite_draw_raw(t_game *game, int len, int draw_end_x,
							float *z_buffer);
